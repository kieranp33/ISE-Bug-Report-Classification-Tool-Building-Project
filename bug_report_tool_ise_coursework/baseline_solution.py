...
print('\n')
print("=== Standard Deviation Results ===") # Prints the standard deviation values for the 5 metrics used in a specified project. Can be verfied with results shown in report (figures 3,4,5,6,7)
