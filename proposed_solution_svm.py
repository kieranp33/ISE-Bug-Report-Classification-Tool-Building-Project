...
if project == "caffe":
    print(f"Wilcoxon Rank Sum P-Value for Precision {ranksums(baseline_precision_caffe,precisions).pvalue}")
    print(f"Wilcoxon Rank Sum P-Value for Recall {ranksums(baseline_recall_caffe,recalls).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for F1-Score {ranksums(baseline_f1_scores_caffe,f1_scores).pvalue}")

if project == "incubator-mxnet":
    print(f"Wilcoxon Rank Sum Precision P-Value for Precision {ranksums(baseline_precision_incubator_mxnet,precisions).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for Recall {ranksums(baseline_recall_incubator_mxnet,recalls).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for F1-Score {ranksums(baseline_f1_scores_incubator_mxnet,f1_scores).pvalue}")

if project == "keras":
    print(f"Wilcoxon Rank Sum Precision P-Value for Precision {ranksums(baseline_precision_keras,precisions).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for Recall {ranksums(baseline_recall_keras,recalls).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for F1-Score {ranksums(baseline_f1_scores_keras,f1_scores).pvalue}")

if project == "tensorflow":
    print(f"Wilcoxon Rank Sum Precision P-Value for Precision {ranksums(baseline_precision_tensorflow,precisions).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for Recall {ranksums(baseline_recall_tensorflow,recalls).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for F1-Score {ranksums(baseline_f1_scores_tensorflow,f1_scores).pvalue}")

if project == "pytorch":
    print(f"Wilcoxon Rank Sum Precision P-Value for Precision {ranksums(baseline_precision_pytorch,precisions).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for Recall {ranksums(baseline_recall_pytorch,recalls).pvalue}")
    print(f"Wilcoxon Rank Sum Precision P-Value for F1-Score {ranksums(baseline_f1_scores_pytorch,f1_scores).pvalue}")
